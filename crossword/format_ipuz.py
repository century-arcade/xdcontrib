...
def from_ipuz(ipuz_dict):
    ...
    for clues in ipuz_dict.get('clues', {}).get('Across', []):
        crossword.clues.across[clues['number']] = clues['clue']
    for clues in ipuz_dict.get('clues', {}).get('Down', []):
        crossword.clues.down[clues['number']] = clues['clue']
